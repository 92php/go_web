...
func main()  {
	...
	/*str := "programming"
	fmt.Println(str[1]) //获取字符串索引位置为1的原始字节，比如r为 114
	fmt.Println(str[1:3]) //截取得字符串索引位置为 1 到 2 的字符串 //ro
	fmt.Println(str[1:]) //截取得字符串索引位置为 1 到 len(s)-1 的字符串 //rogramming
	fmt.Println(str[:3]) //截取得字符串索引位置为 0 到 2 的字符串 //pro
	...
	//str := "go web"
	//fmt.Println(string(str[0])) //获取索引为0的字符 g
